...
license: UNLICENSED
description: Use when working with permissions, authorization, role-based access, or security in ABP projects. Covers PermissionDefinitionProvider, [Authorize] attribute, CheckPolicyAsync, IsGrantedAsync, ICurrentUser, IPermissionManager, and multi-tenancy side.
---
